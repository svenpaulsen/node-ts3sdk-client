...
NAN_METHOD(ClientLib::Init)
{
    ...
    clientSDK.onEditPlaybackVoiceDataEvent            = Event::onEditPlaybackVoiceDataEvent;
    clientSDK.onEditPostProcessVoiceDataEvent         = Event::onEditPostProcessVoiceDataEvent;
    clientSDK.onEditMixedPlaybackVoiceDataEvent       = Event::onEditMixedPlaybackVoiceDataEvent;
    clientSDK.onEditCapturedVoiceDataEvent            = Event::onEditCapturedVoiceDataEvent;
    clientSDK.onCustom3dRolloffCalculationClientEvent = Event::onCustom3dRolloffCalculationClientEvent;
    clientSDK.onCustom3dRolloffCalculationWaveEvent   = Event::onCustom3dRolloffCalculationWaveEvent;
    clientSDK.onUserLoggingMessageEvent               = Event::onUserLoggingMessageEvent;
    clientSDK.onCustomPacketEncryptEvent              = Event::onCustomPacketEncryptEvent;
